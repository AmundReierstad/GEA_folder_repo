...
public class GeneticManager : MonoBehaviour
{
    ...
    public void StartEvolution()  // Starts the evolutionary process.
    {
        ...
        NeuralNet nn = new NeuralNet(nInputsNN,nHiddenLayersNN,nOutputsNN);
        //Setup genetic algorithm
        geneticAlgorithm = new GeneticAlgo((int) nn.numberOfWeights,  PopulationSize);
        genomesSaved = 0;
    ...
    private List<Genome> RandomRecombination(List<Genome> intermediatePopulation, uint newPopulationSize)
    {
        ...
        while (newPopulation.Count < newPopulationSize)
        {
            ...
            GeneticAlgo.CompleteCrossover(intermediatePopulation[randomIndex1], intermediatePopulation[randomIndex2], 
                GeneticAlgo.CrossProbability, out offspring1, out offspring2);
