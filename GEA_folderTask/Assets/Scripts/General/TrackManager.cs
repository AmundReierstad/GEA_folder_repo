...
public class TrackManager : MonoBehaviour
{
            ...
            {
                {
                    ...
                    if (BestCar != null) BestCar.CarMesh.material = normalCarMaterial;
                    if (value != null) value.CarMesh.material = bestCarMaterial;
        ...
        private set
        {
            if (_secondBestCar != value)
            {
                ...
                if (SecondBestCar != null && SecondBestCar != BestCar)
                    SecondBestCar.CarMesh.material = normalCarMaterial;
                if (value != null)
                    value.CarMesh.material = secondBestCarMaterial;
    ...
    void Update()
    {
        ...
        for (int i = 0; i < _cars.Count; i++)
        {
            ...
            if (car.Car.enabled)
            {
                ...
                {
                    BestCar = car.Car;
                    // Debug.Log("new best car: "+ BestCar.gameObject.name);
    ...
    private void CalculateCheckpointPercentages()
    {
        ...
        {
            _checkpoints[i].DistanceToPrevious = Vector3.Distance(_checkpoints[i].transform.position, _checkpoints[i - 1].transform.position);
